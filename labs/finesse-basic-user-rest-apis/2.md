 ...
 * If the value of the ``<state>`` tag is NOT_READY, you can visit <a href="5">Step #5</a> to log the user out. Then, try the Learning Lab again.
 * If the value of the ``<state>`` tag is READY, you can visit <a href="4">Step #4</a> using the *To change to NOT_READY* for the HTTP request body followed by <a href="5">Step #5</a>. Then, try the Learning Lab again.
